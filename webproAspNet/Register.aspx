  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    ...
    <form id="form1" runat="server">
        <div class ="form-group">
            ...
            <asp:TextBox class="form-control" ID="unameTextBox" runat="server"></asp:TextBox>
            <br />
            ...
            <asp:TextBox class="form-control" ID="confirmPassTextBox" runat="server" TextMode="Password"></asp:TextBox>
            <br />
            <asp:Button class="btn btn-primary" ID="registerButton" runat="server" Text="Register" OnClick="RegisterButtonClick" />
        </div>
    </form>
    </div>
</body>
